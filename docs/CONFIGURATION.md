...
| --- | --- | --- |
| `PICTARIA_IMAGE_TAG` | `1.4.1` | Published container image tag selected by `docker-compose.yml`. Image tags omit the `v` used by Git release refs (`1.4.1` versus `v1.4.1`). |
